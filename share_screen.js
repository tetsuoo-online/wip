  ...
  async beforeRegisterNodeDef(nodeType, nodeData, app) {
    ...
    nodeType.prototype.onNodeCreated = function () {
      ...
      this.addWidget(
		...
		this.addWidget("button", "Toggle Preview", "", function (value, widget, node) {
		  const el = previewWidget?.parentEl;
		  if (el) {
			el.style.display = (el.style.display === "none") ? "block" : "none";
			this.label = (el.style.display === "none") ? "Show Preview" : "Hide Preview";
		  }
